    ...
    <body>
        ...
        <div class="container-fluid"><div class="info-container shadow">
            ...
            <div class="tab-content m-2 active" id="myTabContent">
                <input type="url" id="address" onkeydown="loadRoute(event)" value="/dbpanel/doc" class="form-control mr-2 mb-2">
            ...
            <form class="row">
                ...
                <ul class="nav nav-tabs pl-2" id="mySideBarTab" role="tablist">
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="namespace-tab" data-toggle="tab" href="#namespace" role="tab" aria-controls="model" aria-selected="true">Namespace</a>
                      </li>
                      <li class="nav-item">
